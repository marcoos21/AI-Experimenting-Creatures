...
class Creature:
    def __init__(self, gene_count):
        ...
        self.state = 'ground_travel' #Initialize the state of ground_travel
    ...
    def update_position(self, pos):
        ...
        if self.start_position is None:
            ...
            self.initial_distance_to_target = np.linalg.norm(self.start_position - self.target_position)
        self.last_position = pos
    ...
    def get_distance_travelled(self):
        if self.start_position is None or self.last_position is None:
            return 0
        current_distance_to_target = np.linalg.norm(self.last_position - self.target_position)
        distance_travelled = self.initial_distance_to_target - current_distance_to_target
        return max(distance_travelled, 0)  # Ensure the distance is always positive
    ...
    def update_dna(self, dna):
        ...
        self.start_position = None
        self.last_position = None
        self.vertical_distance_climbed = 0

class Link:
    def __init__(self, control_waveform=None, control_amp=1.0, control_freq=1.0):
