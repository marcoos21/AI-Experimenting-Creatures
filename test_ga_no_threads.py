...
data_folder = "pop20_gene5_linkLength0.9_Mass0.01"
        ...
        for iteration in range(50):
            ...
            for cr in pop.creatures:
                if cr.get_distance_travelled() == max_fit:
                    ...
                    filename = os.path.join(data_folder,"elite_"+str(iteration)+".csv")
                    genome.Genome.to_csv(cr.dna, filename, gene_spec)
                    break
